...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 15, 2024 at 05:11 AM
...
('root', '2024-01-23 05:30:43', '{\"Console\\/Mode\":\"collapse\"}');
...
-- Database: `resturent`
--
CREATE DATABASE IF NOT EXISTS `resturent` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `resturent`;
...
CREATE TABLE `product` (
  `ID` int(11) NOT NULL,
  `PRODUCTNAME` varchar(26) NOT NULL,
  `PRODUCTCODE` varchar(26) NOT NULL,
  `PRODUCTAMOUNT` varchar(26) NOT NULL,
  `PRODUCTGST` varchar(26) NOT NULL,
  `IMAGE` varchar(26) NOT NULL
...
INSERT INTO `product` (`ID`, `PRODUCTNAME`, `PRODUCTCODE`, `PRODUCTAMOUNT`, `PRODUCTGST`, `IMAGE`) VALUES
(1, 'shiva', '12df', '1', '11', '0x0.jpg');
...
CREATE TABLE `user` (
  ...
  `PIN` varchar(26) NOT NULL,
  `PAYMENTMODE` int(8) NOT NULL,
...
INSERT INTO `user` (`ID`, `NAME`, `MOBILE`, `ADDRESS`, `PASSWORD`, `PIN`, `PAYMENTMODE`, `DATE`) VALUES
(1, 'shiva', 9556603412, 'rtyui', '12345', '12346', 1, '2024-02-08 21:38:49'),
(2, 'kiran', 9038899352, 'rtyu', '12345', '123', 0, '2024-02-08 21:55:28');

-- --------------------------------------------------------

--
-- Table structure for table `vander_details`
--

CREATE TABLE `vander_details` (
...
--
-- Indexes for table `vander_details`
--
ALTER TABLE `vander_details`
...
--
-- AUTO_INCREMENT for table `vander_details`
--
ALTER TABLE `vander_details`
  MODIFY `VN_ID` int(11) NOT NULL AUTO_INCREMENT;
--
...
(1, 'admin', 'admin', 'admin', NULL, 'Inventory', 'inventory@gmail.com', NULL, NULL, '$', 1);
...
(1, 'Sstor AtoZ 24X7', 'Online Gorcery itms and many more....', '1706337658sstore.png', 'All are Grocery and vegetable are available in 24X7 ...', 'Copyright 2020', 'Rs.', '9556603412', 'shiva@gmail.com', 'Kolkata');
...
(14, '65b2998fceb88', 13, 29, 0, 'sunfor oil', '1', 'sun lit &lt;br&gt;', '1706203535sunflower.jpg', 5, NULL, 11, 1),
(15, '65b38139734e6', 13, 29, 0, 'monser oil', '2', 'Monstard oil&lt;br&gt;', '1706262841musteroil.jpg', 5, NULL, 0, 1),
(16, '65cb848092727', 13, 29, 0, 'oil', '20', 'back to back offer&lt;br&gt;', '1707836544download.jpeg', 3, NULL, 0, 1);
...
(16, 'kiran', 'nayak', 'kiran@gamil.com', '', '12345', '7439191307', 'rty', 'ty', 1),
(15, 'shiva', 'nayak', 'shivanayak@gmail.com', '', '12345', '9556603412', 'maniknager', 'kolkata', 1),
(22, 'Bikash', 'Nayak', 'b90nayak@gmail.com', '', '7f266025dc45f2e14b2415f475cce468', '+916290508769', 'Maaa', 'Kolkata', 1),
(23, 'ertyui', 'tyui', 'shivamans@gamil.com', '', '202cb962ac59075b964b07152d234b70', '900000', 'dfghj', 'dfghjk', 1),
(24, 'se', 'er', 'w2@gaim.com', '', '473447ac58e1cd7e96172575f48dca3b', '234567', 'fgh', 'fg', 1);
